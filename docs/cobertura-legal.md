...
| Distribución irregular | art. 34.2 | **A medias, y la mitad que falta está descartada a propósito.** El **saldo** se lleva y las horas de exceso aparecen en lo que se debe en descanso, con su plazo vencido; el **preaviso de cinco días** se comprueba. Lo que no se calcula es el **10 % del párrafo primero**, por dos motivos que no han cambiado: el tope solo rige *en defecto de pacto* y el producto no sabe si hay convenio que regule la distribución ---que es el caso normal---, y medirlo exigiría la distribución **ordinaria** contra la que comparar, cuando el cuadrante *es* la distribución. Un porcentaje sobre una referencia inventada se lee como un hecho. No es trabajo pendiente: es una decisión, y sigue siendo la misma |
...
| Descanso compensatorio por ampliación sectorial | RD 1561/1995 | Según sector | **Descartado a propósito**, y el saldo lo dice. Tres motivos. Uno: haría falta la cifra de cada sector, y esas cifras **ya están descartadas** ---quince números por cada uno de los trece regímenes, cada sector con su convenio encima---. Dos: esas horas **ya se cuentan una vez**, como horas extra del art. 35.1 o como distribución irregular; una segunda deuda por el mismo trabajo lo contaría dos veces. Y tres: lo que la ampliación cambia es la *naturaleza* de esas horas, y distinguirlas exige saber dónde acaba la jornada ordinaria del sector, que es justo la cifra que falta. **Lo que sí se hace**: si la empresa declara un régimen de ampliación ---nueve de los trece--- el saldo dice en su pantalla que su sector fija descansos compensatorios propios que no se cuentan ahí, y remite al convenio. Un saldo incompleto que no avisa de estarlo es peor que no tener saldo: el primero se cree |
...
cuándo. Al 29/08 son **cinco fuentes** ---35.1, 37.2, 34.2, 36.2 y 19.a--- y la
sexta está descartada a propósito, con el saldo diciéndolo en pantalla. La
pregunta que costaba en cada una no era la maquinaria sino **cuánto** se debe, y
en tres de ellas la respuesta la da el convenio: por eso la empresa las declara
en Ajustes y sin declararlas no se lleva saldo.
