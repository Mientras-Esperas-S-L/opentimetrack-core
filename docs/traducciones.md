...
| La pantalla: botones, rótulos, textos de cada página | **En curso** ---623 de 923 cadenas al 28/08/2026. Trece pantallas enteras, el formulario de pedir una ausencia y todo lo compartido (menú, paginadores, filtros, estados, fechas)--- |
